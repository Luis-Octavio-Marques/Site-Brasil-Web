...
function Header() {
  ...
  return (
    <>
      <header
      className="fixed flex items-center justify-center w-full gap-8 border-b border-white text-white backdrop-blur-sm z-50 animate-fadeIn px-4 py-5 bg-[rgba(0,0,0,0.15)]"
    >
      <Link to="/" className="flex items-center gap-2 group">
        <h2 className="text-[26px] text-white font-light tracking-wider relative">
          Brasil Web
          <div className="absolute -right-4 top-1 h-8 w-[1px] rounded-full bg-gradient-to-t from-transparent via-white/50 to-transparent"></div>
      ...
      <nav className="hidden md:flex items-center">
        ...
        <button
          ...
          className="md:hidden relative flex flex-col justify-center items-center w-10 h-10 focus:outline-none z-60 group transition-all duration-300 hover:bg-white/10 rounded-lg"
          aria-label="Menu"
        >
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 border-t border-white/10">
            <div className="text-center">
              <p className="text-sm text-white/60 mb-2">Explore o Brasil</p>
